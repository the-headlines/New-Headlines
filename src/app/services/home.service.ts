...
export class HomeService {
    ...
    getData(page) {
        return this.http.get(API_URL + '/api/news/' + this.checkAuth() + 'category/Influence?pagesize=30&page=' + page);
    }
    ...
    getPictures(page) {
        return this.http.get(API_URL + '/api/news/' + this.checkAuth() + 'category/CameraPictures?pagesize=30&page=' + page);
    }

    getRoadToFame(page) {
        return this.http.get(API_URL + '/api/news/' + this.checkAuth() + 'category/StyleAndSweat?pagesize=30&page=' + page);
    }

    getDeals(page) {
        return this.http.get(API_URL + '/api/news/' + this.checkAuth() + 'category/LoveDesigns?pagesize=30&page=' + page);
    }

    getCommerce(page) {
        return this.http.get(API_URL + '/api/news/' + this.checkAuth() + 'category/JumpStartups?pagesize=30&page=' + page);
    }

    getTravel(page) {
        return this.http.get(API_URL + '/api/news/' + this.checkAuth() + 'category/HumanStories?pagesize=30&page=' + page);
    }

    getHobbyist(page) {
        return this.http.get(API_URL + '/api/news/' + this.checkAuth() + 'category/Hobbyist?pagesize=30&page=' + page);
    }

    getScience(page) {
        return this.http.get(API_URL + '/api/news/' + this.checkAuth() + 'category/Science?pagesize=30&page=' + page);
    }

    getPublic(page) {
        return this.http.get(API_URL + '/api/news/' + this.checkAuth() + 'category/Public?pagesize=30&page=' + page);
    }

    getEnvironment(page) {
        return this.http.get(API_URL + '/api/news/' + this.checkAuth() + 'category/Environment?pagesize=30&page=' + page);
    }

    getPostsByCategory(category) {
        return this.http.get(`${API_URL}/api/user/news/${category}?pagesize=30&page=1`);
    }

    getVoiceValue() {
        return this.http.get(API_URL + '/api/news');
    }
    ...
    public getPost(data) {
        return this.http.post(API_URL + '/api/news?pagesize=100&page=1', data);
    }

    public getVideo(page) {
        return this.http.get(API_URL + '/api/news/' + this.checkAuth() + 'category/Science?pagesize=100&page=' + page);
    }
    ...
    getPostsByVoteType(category, vote, type = 'New') {
        if (vote !== 'All') {
            return this.http.get(`${API_URL}/api/news/${this.checkAuth()}category/${category}/vote/${vote}?filter=${type}&pagesize=30&page=1`);
        } else {
            return this.http.get(`${API_URL}/api/news/${this.checkAuth()}category/${category}?filter=${type}&pagesize=30&page=1`);
        }
    }
}
